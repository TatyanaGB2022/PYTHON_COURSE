...
def print_operation_table(operation, num_rows=9, num_columns=9):
    ...
    for i in range(1, num_rows + 1):
        ...
        print(" ".join(row)) # в кавычках ставится какой-то символ, затем join и  в скобках берется итерируемый 
        # объект и он этот символ, который слева от точки, вставлять между каждым эл-ом списка и создавать 
        # цельную строку
